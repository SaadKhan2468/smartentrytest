    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ padding: 4, backgroundColor: "background.default", minHeight: "100vh" }}>
        ...
        >
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={4}>
              <Box
                component="img"
                src="https://i.ibb.co/RXqt6br/Lamp-books-and-objects-for-studying.png" // Replace with your actual image URL
        ...
        <Grid item xs={12} md={4}>
              <Box
                component="img"
                src="https://i.ibb.co/70FytjP/Screenshot-2025-05-03-160447.png" // Replace with your actual image URL
                alt="Hero Illustration"
